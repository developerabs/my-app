...
use App\Services\Accounting\Reports\ProfitAndLossService;
use Carbon\Carbon;
...
class ProfitAndLossController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $reportData = $this->pnlService->getProfitAndLossData($fromDate, $toDate, $effectiveBranch);
        ...
        return view('backend.accounting.reports.profit_and_loss', array_merge($reportData, [
            'branches'           => $branches,
