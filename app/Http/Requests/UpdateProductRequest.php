...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        // প্রোডাক্ট আপডেট করার পারমিশন চেক
    ...
    {
        // বর্তমান প্রোডাক্ট আইডিটি রাউট থেকে নেওয়া হচ্ছে
        ...
        return [
            ...
            // SKU আপডেট করার সময় বর্তমান প্রোডাক্ট আইডি ইগনোর করা হয়েছে
            'sku' => [
                'required', 
                'string', 
                'max:100', 
            ...
            'tax_type' => ['required', 'in:exclusive,inclusive', 'string', 'max:50'],
