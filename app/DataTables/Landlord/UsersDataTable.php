        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row){
                if ($row->hasRole('Super-Admin')) {
                    ...
                    $edit = '<a href="javascript:void(0)" onclick="editUser('.$row->id.')" class="btn  btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>';
                    $delete = '<button type="button" onclick="deleteUser('.$row->id.')" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button>';
                }
                return $edit.' '.$delete;
            })
