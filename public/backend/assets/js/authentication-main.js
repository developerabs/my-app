...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", baseUrl + "/backend/assets/libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    let html = document.querySelector('html');
    html.setAttribute("dir", "rtl");
    document.querySelector("#style")?.setAttribute("href", baseUrl + "/backend/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
}