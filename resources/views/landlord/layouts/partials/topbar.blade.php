            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element country-selector">
                        <!-- Start::header-link|dropdown-toggle -->
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            <img src="{{ asset($locales[$currentLocale]['flag']) }}" alt="flag" width="20" height="15">
                        </a>
                        <!-- End::header-link|dropdown-toggle -->
                        <ul class="main-header-dropdown dropdown-menu dropdown-menu-end country-dropdown" data-popper-placement="none">
                            @foreach($locales as $key => $locale)
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('switchLang', $key) }}">
                                        <span>
                                            <img src="{{ asset($locale['flag']) }}" alt="img" class="avatar avatar-xs lh-1 me-2">
                                        </span>
                                        {{ $locale['name'] }}
                                    </a>
                                </li>
                    ...
                    <div class="header-element headerProfile-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            ...
                            <span style="height: 37px; width: 37px; line-height: 37px; border-radius: 50%; font-size: 16px;" class="bg-primary text-fixed-white text-center">{{ $initials }}</span>
                        </a>
                        <!-- End::header-link|dropdown-toggle -->
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                            <li>
                                <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 lh-1 text-fixed-white text-uppercase">{{ Auth::user()->name }}</h6><span class="fs-11 op-7 lh-1">{{ Auth::user()->email }}</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex" href="{{ route('landlord.myprofile') }}">
                            ...
                            <li>
                                <form action="{{ route('landlord.logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="dropdown-item d-flex"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Sign Out</button>
                                </form>
                            </li>
                        </ul>
                    </div>
