...
@push('css')
    <style>
        ...
        .step-content h6 { margin-bottom: 2px; font-weight: 700; font-size: 0.9rem; }
        .step-content p { margin: 0; color: #6c757d; font-size: 0.8rem; }

        .setup-step.active .step-icon { background: #0d6efd; }
                ...
                <div class="col-lg-5">
                    <div class="right-panel h-100">
                        ...
                        <div class="summary-box">
                            <div class="summary-item"><span>Total Steps</span> <strong>4</strong></div>
                            <div class="summary-item"><span>Current Step</span> <strong>Regional Settings</strong></div>
                            <div class="summary-item"><span>Completion</span> <strong>0%</strong></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="left-panel h-100">
                        <div>
                            ...
                            <p class="text-muted mt-2 mb-3">Welcome to your ERP system. Before you begin, complete a few quick setup steps.</p>
                            <div>
                                <div class="d-flex justify-content-between mb-1 small fw-semibold"><span>Setup Progress</span> <span>0%</span></div>
                        ...
                        <form action="{{ route('setup.store') }}" method="POST" class="mt-auto pt-3">
                            @csrf
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="agree_tnc" value="1" required id="agree">
                                <label class="form-check-label small" for="agree">I agree to the <a href="#">Terms & Conditions</a> and <a href="#">Privacy Policy</a></label>
                            </div>
                            <button class="btn btn-primary w-100"><i class="bi bi-arrow-right-circle me-2"></i> Start Setup</button>
                        </form>
                    </div>
                </div>
            </div>
