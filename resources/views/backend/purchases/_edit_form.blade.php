        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3">
                <div class="row align-items-end">
                    ...
                    <!-- 🟢 Generic Journal Header Partial -->
                ...
                <div class="table-responsive my-3">
                    <table class="table table-sm border table-bordered align-middle" id="purchase-table">
                        ...
                        <tbody id="purchase_body">
                            <!-- 💡 Direct Server-Side Hydration for Edit Mode -->
                            @if($isEdit && isset($purchase) && $purchase->items->count() > 0)
                                @foreach($purchase->items as $item)
                                    @include('backend.purchases._item_row', ['item' => $item])
                                @endforeach
                            @endif
                        </tbody>
                    </table>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <input type="number" name="paid_amount" id="paid-amount"
                                            ...
                                            value="{{ isset($purchase) ? number_format($purchase->paid_amount, 2, '.', '') : '0.00' }}" min="0" step="any">
                                    </div>
