            ...
            <div class="card-header bg-white py-3">
                <div class="row align-items-end">
                    ...
                    @include('backend.accounting.partials.journal-header', [
                        'model'       => $purchase ?? null,
                        'dateLabel'   => __('file.field.purchase_date'),
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label fw-bold mb-1">{{ __('file.field.select_supplier')}} <span class="text-danger">*</span></label>
                        <select name="supplier_id" id="supplier_id" class="form-select form-select-sm supplier-select" required>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label fw-bold mb-1">{{__('file.field.payment_account')}}</label>
                    ...
                    <!-- Purchase Status -->
                    <div class="col-md-2 mb-3">
                        <label for="purchase_status" class="form-label fw-bold mb-1">{{__('file.field.purchase_status') }} <span class="text-danger">*</span></label>
                    ...
                    <!-- Reference No -->
                    <div class="col-md-2 mb-3">
                        <label for="reference" class="form-label fw-bold mb-1">{{ __('file.field.reference') }}</label>
                    ...
                    <!-- Memo / Invoice Number -->
                    <div class="col-md-2 mb-3">
                        <label for="memo_number" class="form-label fw-bold mb-1">{{ __('file.field.memo_number') }}</label>
                ...
                <div class="row g-3 flex-column-reverse flex-md-row mt-2">
                    <div class="col-md-7 col-lg-8">
                        <div class="p-3 border rounded bg-white shadow-sm">
                            <label class="small fw-bold mb-1">{{__('file.field.note')}}</label>
                            ...
                            <label class="small fw-bold mb-1">{{__('file.field.attach_document')}}</label>
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <strong id="sub-total" class="text-dark">0.00</strong>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <strong class="text-primary fs-6" id="grand-total">0.00</strong>
                                    </div>

                                    <!-- Paid Amount (JS will populate properly without triggering false alarms) -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <input type="number" name="paid_amount" id="paid-amount"
                                            ...
                                            onchange="if(typeof ProductManager !== 'undefined') ProductManager.calculateDue();" style="width: 130px;"
                                            value="0" min="0" step="any">
                                    </div>

                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="fw-bold text-danger small">{{ __('Due Amount') }}:</span>
                                        <strong class="text-danger fs-6" id="due-amount">0.00</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-4 mb-2">
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-success px-4 shadow">
                            <i class="fa fa-save me-1"></i>{{ $isEdit ? __('file.button.update') : __('file.button.create')}} {{__('file.purchase')}}</button>
                    </div>
                </div>
