  <!-- Start::main-sidebar-header -->
            <div class="main-sidebar-header">
                <a href="{{route('dashboard')}}" class="header-logo">
                    <img style="height: 3rem;" src="{{ $general_settings['company_logo'] ?? url('landlord/images/logo.png')}}" alt="logo" class="desktop-logo">
                    <img src="{{ $general_settings['toggle_logo'] ?? url('landlord/images/logo.png')}}" alt="logo" class="toggle-logo">
                    <img style="height: 3rem;" src="{{ $general_settings['white_logo'] ?? url('landlord/images/logo.png')}}" alt="logo" class="desktop-white">
                    <img src="{{ $general_settings['white_toggle_logo'] ?? url('landlord/images/logo.png')}}" alt="logo" class="toggle-white">
                </a>
            </div>
