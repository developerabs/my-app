...
<header class="app-header">
    ...
    <div class="main-header-container container-fluid">
                ...
                <div class="horizontal-logo">
                    <a href="{{ route('dashboard') }}" class="header-logo">
                        <img style="height: 3rem;"
                            src="{{ $general_settings['company_logo'] ?? url('landlord/images/logo.png') }}"
                            alt="logo" class="desktop-logo">
                        <img src="{{ $general_settings['toggle_logo'] ?? url('landlord/images/logo.png') }}"
                            alt="logo" class="toggle-logo">
                        <img style="height: 3rem;"
                            src="{{ $general_settings['white_logo'] ?? url('landlord/images/logo.png') }}"
                            alt="logo" class="desktop-white">
                        <img src="{{ $general_settings['white_toggle_logo'] ?? url('landlord/images/logo.png') }}"
        ...
        <div class="header-content-right">
            ...
            <!-- Force Re-sync Button (Hidden on Mobile) -->
            <div class="header-element country-selector d-none d-md-flex align-items-center">
                <button type="button" class="btn btn-sm btn-outline-danger shadow-sm me-2" id="btn_open_force_sync_modal" title="Force Clear & Re-Sync POS Cache">
                    <i class="fa-solid fa-arrows-rotate"></i>
                </button>
            </div>

            <!-- Store Purchase (Desktop Only) -->
            <div class="header-element d-none d-lg-flex">
                <a href="{{ route('store-purchase') }}" class="header-link" title="Store Purchase">
                    <svg class="header-link-icon" width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512">
                        <path
            ...
            <!-- Country/Language Selector (Desktop Only) -->
            <div class="header-element country-selector d-none d-lg-flex">
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                    data-bs-toggle="dropdown">
                    <img src="{{ url($locales[$currentLocale]['flag'] ?? '') }}" alt="flag" width="20" height="15">
                </a>
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end country-dropdown" data-popper-placement="none">
                    @foreach ($locales as $key => $locale)
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('tanant.switchLang', $key) }}">
                                <span><img src="{{ url($locale['flag']) }}" alt="img" class="avatar avatar-xs lh-1 me-2"></span>
                                {{ $locale['name'] }}
                            </a>
                        </li>
                    @endforeach
            ...
            <!-- Dark/Light Theme Switcher (Desktop Only) -->
            <div class="header-element header-theme-mode d-none d-lg-flex">
            ...
            <!-- Messages Dropdown (Desktop/Tablet Only) -->
            <div class="header-element messages-dropdown d-none d-md-flex">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ url('backend') }}/assets/images/faces/12.jpg" alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                                        <a href="chat.html"><h6 class="mb-1 name">Petey Cruiser</h6></a>
                                    </div>
                                    <p class="mb-0 fs-12 desc">I'm sorry but i'm not sure how to help you...</p>
            ...
            <!-- Notifications Dropdown (Always Visible on Mobile/Desktop) -->
            <div class="header-element notifications-dropdown main-header-notification">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message" data-popper-placement="none">
                    <div class="menu-header-content bg-primary text-fixed-white">
                        ...
                        <p class="dropdown-title-text subtext mb-0 text-fixed-white op-6 pb-0 fs-12 ">You have unread Notifications</p>
                    </div>
                    <div><hr class="dropdown-divider"></div>
            ...
            <div class="header-element header-fullscreen d-none d-lg-flex">
            ...
            <!-- 💡 Start::MOBILE MORE OPTIONS DROPDOWN (শুধুমাত্র মোবাইল/ট্যাবলেটে দেখাবে) -->
            <div class="header-element d-flex d-lg-none">
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-ellipsis-vertical header-link-icon fs-18"></i>
                </a>
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end p-2 shadow-lg" style="min-width: 210px;">
                    <!-- Mobile Language Switcher -->
                    <li class="dropdown-item d-flex align-items-center justify-content-between py-2 border-bottom">
                        <span class="small fw-bold text-dark">{{ __('Language') }}</span>
                        <div class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle text-dark" data-bs-toggle="dropdown">
                                <img src="{{ url($locales[$currentLocale]['flag'] ?? '') }}" alt="flag" width="20" height="15" class="rounded">
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                @foreach ($locales as $key => $locale)
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center" href="{{ route('tanant.switchLang', $key) }}">
                                            <img src="{{ url($locale['flag']) }}" alt="img" class="avatar avatar-xs me-2">
                                            {{ $locale['name'] }}
                                        </a>
                                    </li>
                                @endforeach
                    ...
                    <li class="dropdown-item d-flex align-items-center justify-content-between py-2 border-bottom">
                        <span class="small fw-bold text-dark">{{ __('Theme Mode') }}</span>
                        <a href="javascript:void(0);" class="layout-setting text-dark">
                            <span class="light-layout"><i class="fa-regular fa-moon fs-16 text-primary"></i></span>
                            <span class="dark-layout"><i class="fa-regular fa-sun fs-16 text-warning"></i></span>
                        </a>
                    </li>

                    <!-- Mobile Force Re-Sync Button -->
                    <li class="dropdown-item py-2 border-bottom">
                        <a href="javascript:void(0);" class="text-danger d-flex align-items-center fw-semibold" onclick="$('#btn_open_force_sync_modal').click();">
                            <i class="fa-solid fa-arrows-rotate me-2"></i> {{ __('Re-Sync POS Cache') }}
                        </a>
                    </li>

                    <!-- Mobile Store Purchase Link -->
                    <li class="dropdown-item py-2 border-bottom">
                        <a href="{{ route('store-purchase') }}" class="text-dark d-flex align-items-center fw-semibold">
                            <i class="fa-solid fa-store me-2 text-primary"></i> {{ __('Store Purchase') }}
                        </a>
                    </li>

                    <!-- Mobile Theme Settings Offcanvas -->
                    <li class="dropdown-item py-2">
                        <a href="javascript:void(0);" class="text-dark d-flex align-items-center fw-semibold" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas">
                            <i class="fa-solid fa-gear me-2 text-secondary"></i> {{ __('Customize Theme') }}
                        </a>
                    </li>
                </ul>
            </div>
            <!-- 💡 End::MOBILE MORE OPTIONS DROPDOWN -->
            ...
            <div class="header-element headerProfile-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <span style="height: 37px; width: 37px; line-height: 37px; border-radius: 50%; font-size: 16px;"
                        class="bg-primary text-fixed-white text-center d-inline-block fw-bold">{{ $initials }}</span>
                </a>
                <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                    ...
                    <li>
                        <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                            <div class="my-auto">
                                <h6 class="mb-0 lh-1 text-fixed-white text-uppercase">{{ Auth::user()->name }}</h6>
                    ...
                    @can('manage_activity_log')
                        <li><a class="dropdown-item d-flex" href="{{ route('activity-log') }}"><i
                                    class="fa-regular fa-clock fs-16 me-2 op-7"></i>Activity Log</a></li>
                    @endcan
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="dropdown-item d-flex"><i
            ...
            <!-- Settings Switcher Gear (Desktop Only) -->
            <div class="header-element d-none d-lg-flex">
            ...
            <!-- Wifi Network Status Icon (Always Visible) -->
            <div class="header-element">
                <span id="network-status" style="margin-left:auto; cursor:pointer;" title="Checking network...">
                    <span id="wifi-icon-container"></span>
                </span>
            </div>
         ...
         <div class="tab-content">
                 ...
                 <div class="list-group list-group-flush ">
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg online avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/1.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg online avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/2.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/3.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/4.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                             <strong>Madeleine</strong> Hey! there I' am available....
                             <div class="small text-muted">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/5.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                             <strong>Anthony</strong> New product Launching...
                             <div class="small text-muted">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/6.jpg" alt="img">
                         </span>
                         <div class="ms-3">
                             <strong>Olivia</strong> New Schedule Realease......
                             <div class="small text-muted">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-lg avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/7.jpg" alt="img">
                         </span>
                         <div class="ms-3">
             ...
             <div class="tab-pane border-start-0 border-end-0 rounded-0 p-0 active show" id="friends"
                 ...
                 <div class="list-group list-group-flush ">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-md online avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/8.jpg" alt="img">
                         </span>
                         <div class="ms-2">
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-md online avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/9.jpg" alt="img">
                         </span>
                         <div class="ms-2">
                             <div class="fw-semibold" data-bs-toggle="modal" data-bs-target="#chatmodel">Florinda
                                 Carasco</div>
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-md online avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/10.jpg" alt="img">
                         </span>
                         <div class="ms-2">
                             <div class="fw-semibold" data-bs-toggle="modal" data-bs-target="#chatmodel">Alina
                                 Bernier</div>
                     ...
                     <div class="list-group-item d-flex  align-items-center">
                         <span class="avatar avatar-md avatar-rounded flex-shrink-0">
                             <img src="{{ url('backend') }}/assets/images/faces/11.jpg" alt="img">
                         </span>
                         <div class="ms-2">
                             <div class="fw-semibold" data-bs-toggle="modal" data-bs-target="#chatmodel">Zula
                                 Mclaughin</div>
             ...
             <div class="card overflow-hidden mb-0 border-0 shadow-none rounded">
                 ...
                 <div class="action-header clearfix">
                     <div class="float-start hidden-xs d-flex">
                         <div class="avatar avatar-lg rounded-circle me-3">
                             <img src="{{ url('backend') }}/assets/images/faces/6.jpg"
                 ...
                 <div class="card-body msg_card_body">
                     ...
                     <div class="d-flex justify-content-end ">
                         ...
                         <div class="img_cont_msg">
                             <img src="{{ url('backend') }}/assets/images/faces/9.jpg"
                                 class="rounded-circle user_img_msg" alt="img">
                         </div>
                     </div>
                     <div class="d-flex justify-content-start ">
